...
### スライド
[スプレッドシート操作1（スライド）]({{SUPABASE_STORAGE_URL}}/slides/gas/slide-04.pdf)
...
### スライド
[スプレッドシート操作2（スライド）]({{SUPABASE_STORAGE_URL}}/slides/gas/slide-05.pdf)
...
### スライド
[データベース活用（スライド）]({{SUPABASE_STORAGE_URL}}/slides/gas/slide-06.pdf)
