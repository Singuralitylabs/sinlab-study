...
BEGIN
  ...
  FOR r IN
    SELECT * FROM (VALUES
      ...
      (5, 'その他GAS活用', 'Geminiを使ったドキュメント自動要約',
    ...
    ) AS t(phase_no, phase_name, topic, descr, video_url, slide)
    ORDER BY phase_no
  LOOP
    -- フェーズ get-or-create
